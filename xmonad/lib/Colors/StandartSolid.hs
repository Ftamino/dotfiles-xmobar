module Colors.StandartSolid where

import XMonad

colorScheme = "StandartSolid"
...
color15 = "#5fb3b3" --
color16 = "#d8dee9" --
colorName = "xmobar-solid.conf" --Xmobar Config to be used for mon 1
colorName0 = "xmobar0-solid.conf" --Xmobar Config to be used for mon 2

colorTrayer :: String
colorTrayer = "--transparent true --alpha 0  --tint 0x002b36 --edge top --align right --widthtype request --heighttype pixel --height 30 --SetDockType true --SetPartialStrut true --distance 10 --margin 20" --Alpha for trayer (256=transperent; 0=solid)
